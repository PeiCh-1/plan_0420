...
【二次調整原則】
1. 指標選用：請從上方清單中『精選 3 到 5 項』與該生最切身的指標進行更深入的個別化改寫。
2. 二次改寫語法：必須以原始指標內容為主體，僅針對必要處微調。**標記語法必須精確為 [+內容+] 與 [-內容-]，中間嚴禁出現空格或如 [- +] 之類的錯誤符號。**
3. 調整策略：為挑選的指標，從內容、歷程、環境、評量四面向各選 1~2 項最適合此學生的策略目標。
